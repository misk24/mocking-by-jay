...
import { artists, artistSection } from "./constant";

export function Artist() {
  const artistSocials = socials.filter((item) =>
    artists.some((artist) => artist.socials.includes(item.id)),
  );
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`${artistSection.book.href}${artist.slug}`}>
                      {artistSection.book.label} {artist.name}
                    </Link>
                  </Button>
                </div>
              </div>
