import { submitArtistBooking } from "@/app/booking/artist/action";
import {
  ArtistBookingFormValues,
  artistBookingSchema,
} from "@/app/booking/artist/schema";
...
import { artistOption, eventTypes } from "./constant";

export default function ArtistBookingForm() {
  const [state, formAction] = useActionState(submitArtistBooking, {
    status: "idle",
  });
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-10 bg-background border-b border-border">
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          ...
          >
            <Link href="/">
              <Button variant="urban" className="mb-2">
